"""Tests for the `l2_backups_and_pitr` homework scaffold.
...
def test_integration():
    """Интеграция: подключиться к реальному PostgreSQL и проверить логику урока «Бэкапы и PITR: pg_dump, pg_basebackup, WAL archiving, pgBackRest»."""
